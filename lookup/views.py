...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json"
                                   "&zipCode="+ zipcode +
                                   "&distance=3000&API_KEY=CD361990-C3DF-4027-AE14-1FC4D2F922C7")
        ...
        if api[0]['Category']['Name'] == "Good":
            ...
            category_description = "(101 - 150) Although general public is not likely to be affected at this AQI " \
                                   "range, people with lung disease, older adults and children are at a greater risk " \
                                   "from exposure to ozone, whereas persons with heart and lung disease, older adults " \
            ...
            category_description = "(301 - 500) Health warnings of emergency conditions. The entire population is " \
        ...
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json"
                                   "&zipCode=11373&distance=3000&API_KEY=CD361990-C3DF-4027-AE14-1FC4D2F922C7")
        ...
        if api[0]['Category']['Name'] == "Good":
            ...
            category_description = "(301 - 500) Health warnings of emergency conditions. The entire population is more " \
